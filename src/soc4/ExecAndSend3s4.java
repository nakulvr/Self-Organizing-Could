 ...
 * @author user
 */
public class ExecAndSend3s4 extends javax.swing.JFrame {
...
//    public static double smb=Provider1.smb;
    ...
    String pdffileName=ReceiveT2ExecS4.pdfFileName;
    int countWords=0,countChar=0;
    
    public ExecAndSend3s4() {
        initComponents();
        try
        {
    ...
    private void VActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VActionPerformed
        ...
        try {
            ...
            System.out.println("sending from ==> ./CompletedTask/"+pdffileName+".pdf");
    ...
    //                                      
                    ...
                    Logger.getLogger(ExecAndSend3s4.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExecAndSend3s4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
