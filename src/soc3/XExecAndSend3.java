 ...
 * @author user
 */
public class XExecAndSend3 extends javax.swing.JFrame {
...
//    public static double smb=Provider1.smb;
    ...
    String fileName=ReceiveT2ExecS3.fileName;
    int countWords=0,countChar=0;
    
    public XExecAndSend3() {
        initComponents();
        try
        {
...
//            {
//                stt=new StringTokenizer(read," ");
//                while(stt.hasMoreTokens()){
//                    stt.nextToken();
//                    countWords++;
//                }
//                
//                stt=new StringTokenizer(read,"abcdefghijklmnopqrstuvwxyz1234567890");
//                while(stt.hasMoreTokens()){
//                    stt.nextToken();
//                    countChar++;
//                }
//            }
//            jTextArea1.append("Number of Words\t"+countWords+"\n\n"+
//                              "Number of Characters\t"+countChar);
    ...
    private void e1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_e1ActionPerformed
        try {
            ...
            ps.println(countWords);
            ps.println(countChar);
            ps.close();
            s.close();
            
        } catch (IOException ex) {
            Logger.getLogger(XExecAndSend3.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XExecAndSend3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new XExecAndSend3().setVisible(true);
            }
        });
    }
