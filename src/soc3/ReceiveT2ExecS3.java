 ...
 * @author user
 */
public class ReceiveT2ExecS3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(460, 120, 250, 30);
    ...
    private void VActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VActionPerformed
        ...
        try {
            Socket s=new Socket("192.168.1.30",1300);            
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiveT2ExecS3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ReceiveT2ExecS3().setVisible(true);
            }
        });
    }
