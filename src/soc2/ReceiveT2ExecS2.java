 ...
 * @author user
 */
public class ReceiveT2ExecS2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(500, 120, 210, 30);
    ...
    private void VActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VActionPerformed
        ...
        try {
            Socket s=new Socket("192.168.1.30",1200);            
    ...
    private void e1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_e1ActionPerformed
        // TODO add your handling code here:
        new ExecAndSend3s2().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiveT2ExecS2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ReceiveT2ExecS2().setVisible(true);
            }
        });
    }
