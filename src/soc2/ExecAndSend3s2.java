 ...
 * @author user
 */
public class ExecAndSend3s2 extends javax.swing.JFrame {
...
//    public static double smb=Provider1.smb;
    ...
    String pdffileName=ReceiveT2ExecS2.pdfFileName;
    int countWords=0,countChar=0;
    
    public ExecAndSend3s2() {
        initComponents();
        try
        {
...
//                ps.println(test);
    ...
    //                                      
                    ...
                    Logger.getLogger(ExecAndSend3s2.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExecAndSend3s2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
