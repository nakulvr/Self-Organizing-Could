 ...
 * @author user
 */
public class ReceiveT2Exec extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(20, 170, 560, 30);
        ...
        jScrollPane1.setBounds(20, 220, 640, 260);
    ...
    private void VActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VActionPerformed
        ...
        try {
            ...
            String read="";
            BufferedWriter bw=new BufferedWriter(new FileWriter("./ExecuteTask/"+fileName));
    ...
    private void e1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_e1ActionPerformed
        // TODO add your handling code here:
         new ExecAndSend3().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceiveT2Exec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ReceiveT2Exec().setVisible(true);
            }
        });
    }
