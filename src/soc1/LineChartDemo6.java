...
public class LineChartDemo6 extends ApplicationFrame {
    ...
    private XYDataset createDataset() {
        ...
        series3.add(3.0, 4.0,true);
        series3.add(4.0, 3.0,true);
        series3.add(5.0, 2.0,true);
        series3.add(6.0, 3.0,true);
        series3.add(7.0, 6.0,true);
        series3.add(8.0, 3.0,true);
        series3.add(9.0, 4.0,true);
        series3.add(10.0, 3.0,true);
