 ...
 * @author user
 */
public class ExecAndSend3 extends javax.swing.JFrame {
...
//    public static double smb=Provider1.smb;
    ...
    String pdffileName=ReceiveT2Exec.pdfFileName;
    ...
    private void VActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VActionPerformed
        ...
        try {
            ...
            for (int i = 1; i <= pageSize; i++) {
                ...
                System.out.println("sendng : "+test);
                if(test.length()==0){}
                else
                    ps.println(test);
            }
    ...
    //                                      
                    ...
                    Logger.getLogger(ExecAndSend3.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExecAndSend3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
