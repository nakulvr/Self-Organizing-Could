 ...
 * @author user
 */
public class Provider1 extends javax.swing.JFrame {
...
//                    System.out.println(cp.toString()+" CPU : "+(cpd)+ " %");
               ...
               /*     double processCpuTime = 0;
                   // if ( ManagementFactory.getOperatingSystemMXBean() instanceof OperatingSystemMXBean )
                    {
                        processCpuTime =  ( (OperatingSystemMXBean) ManagementFactory.getOperatingSystemMXBean() ).getSystemLoadAverage();
                    }
    ...
    private void VActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VActionPerformed
        // TODO add your handling code here:
        P2DimensionVector pd=new P2DimensionVector();
        pd.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Provider1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
